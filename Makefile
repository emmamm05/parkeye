...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Mon Nov 17 07:18:51 2014
# Project:  parkeye.pro
# Template: app
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/arm-linux-gnueabihf -L/usr/local/lib -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_ocl -lopencv_nonfree -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
